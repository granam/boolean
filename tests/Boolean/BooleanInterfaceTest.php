...
class BooleanInterfaceTest extends TestCase
{
    ...
    {
        self::assertTrue(
            interface_exists(BooleanInterface::class),
            'Can not find interface ' . BooleanInterface::class
        );
    }
    ...
    public function inherits_from_scalar_interface(): void
    {
        self::assertTrue(
            ...
            sprintf('Expected %s to be a descendant of %s', BooleanInterface::class, ScalarInterface::class)
        );
    }
}
